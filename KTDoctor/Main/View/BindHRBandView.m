...
- (void)showUsers:(UIButton*)sender {
    ...
    self.nameTableview = [[UITableView alloc] initWithFrame:CGRectMake(kBindView_LeftMargin * kXScal + self.nameView.frame.origin.x, CGRectGetMaxY(self.nameView.frame) + kBindView_TopMargin * kYScal, self.nameView.contentTF.frame.size.width, 160) style:UITableViewStylePlain];
...
- (void)showDevices:(UIButton*)sender {
    ...
    [self.nameTableview removeFromSuperview];
    UIWindow *keyWindow = [UIApplication sharedApplication].keyWindow;
    self.deviceTableview = [[UITableView alloc] initWithFrame:CGRectMake(kBindView_LeftMargin * kXScal + self.hrDeviceView.frame.origin.x, CGRectGetMaxY(self.hrDeviceView.frame) + kBindView_TopMargin * kYScal, self.hrDeviceView.contentTF.frame.size.width, 160) style:UITableViewStylePlain];
