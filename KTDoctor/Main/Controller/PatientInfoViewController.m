...
- (void)configLatestInfoView {
    ...
    self.latestKFXTHRTF.unitLbl.text = @"mmol/L";
    ...
    self.latestGMDZDBTF.unitLbl.text = @"mmol/L";
...
- (void)configOlderInfoView {
    ...
    self.olderKFXTHRTF.unitLbl.text = @"mmol/L";
    ...
    self.olderGMDZDBTF.unitLbl.text = @"mmol/L";
    ...
    self.olderSTZLZSTF.unitLbl.text = @"mmol/L";
