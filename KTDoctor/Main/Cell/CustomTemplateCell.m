...
- (void)setUI {
    ...
    CGFloat itemLbl_Width = (customListviewSize.width - CGRectGetMaxX(self.checkBtn.frame) - kCheck_RightMargin * kXScal - kHeaderView_RightMargin * kXScal - 8 * kMiddleLine_Width)/9;
    ...
    self.seperateLine = [[UIView alloc] initWithFrame:CGRectMake(self.nameLbl.frame.origin.x, kCell_Height * kYScal - kSeperateLine_Height, itemLbl_Width * 9 + 8 * kMiddleLine_Width * kXScal, kSeperateLine_Height )];
