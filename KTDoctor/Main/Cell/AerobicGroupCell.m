...
@implementation AerobicGroupCell
...
- (void)setUI {
    self.groupView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width - (2 * kAddBtn_LeftMargin + kAddBtn_Width)* kXScal, kCell_Height * kYScal)];
    self.groupView.layer.cornerRadius = 4;
    self.groupView.layer.masksToBounds = YES;
    self.groupView.backgroundColor = [UIColor colorWithHexString:@"#F5FDFF"];
    ...
    [self.groupView addSubview:self.difficultyPercentLbl];
    ...
    [self.groupView addSubview:self.difficultyImg];
    ...
    [self.groupView addSubview:self.difficultyLeftMenu];
    ...
    [self.groupView addSubview:self.difficultyTildeLbl];
    ...
    [self.groupView addSubview:self.traingingTimeLbl];
    ...
    [self.groupView addSubview:self.traingingTimeLeftMenu];
    ...
    [self.groupView addSubview:self.traingingTimeMinLbl];
    ...
    [self.groupView addSubview:self.traingingTimeRightMenu];
    ...
    [self.groupView addSubview:self.traingingTimeSecLbl];
    ...
    [self.groupView addSubview:self.difficultyLbl];
    ...
    [self.groupView addSubview:self.difficultyMenu];
    ...
    [self.groupView addSubview:self.rpeZoneLbl];
    ...
    [self.groupView addSubview:self.rpeLeftMenu];
    ...
    [self.groupView addSubview:self.rpeTildeLbl];
    ...
    [self.groupView addSubview:self.rpeRightMenu];
    ...
    [self.groupView addSubview:self.restLbl];
    ...
    [self.groupView addSubview:self.restLeftMenu];
    ...
    [self.groupView addSubview:self.restMinLbl];
    ...
    [self.groupView addSubview:self.restRightMenu];
    ...
    [self.groupView addSubview:self.restSecLbl];
    
    CGFloat topMargin = (self.groupView.frame.size.height - 2 * kAddBtn_Width * kYScal - kAddBtn_BottomMargin * kYScal)/2;
    self.addBtn = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.groupView.frame) + kAddBtn_LeftMargin * kXScal, topMargin, kAddBtn_Width * kYScal, kAddBtn_Width * kYScal)];
