...
@property (nonatomic, copy)  handlerBlock resetButtonHandlerBlock;
...
@property (nonatomic, copy) NSString *resetButtonText;
@property (nonatomic, copy) UIFont *resetButtonFont;
@property (nonatomic, copy) UIColor *resetButtonTextColor;
@end
