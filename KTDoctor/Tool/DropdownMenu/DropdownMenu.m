...
@implementation DropdownMenu
{
    ...
    NSString * _mainTitle;//按钮标题
    UIColor *_bgColor;//按钮背景颜色
...
- (void)setMenuTitlesWithMainTitle:(NSString*)mainTitle bgColor:(UIColor*)color titleArr:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight{
    ...
    [_mainBtn setTitle:_mainTitle forState:UIControlStateNormal];
    [_mainBtn setTitleColor:[UIColor colorWithHexString:@"#9fb5bd"] forState:UIControlStateNormal];
