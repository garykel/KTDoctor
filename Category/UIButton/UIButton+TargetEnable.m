...
#import "UIButton+TargetEnable.h"

@implementation UIButton (TargetEnable)
...
- (void)mySendAction:(SEL)action to:(id)target forEvent:(UIEvent*)event{
    if ([NSStringFromClass(self.class) isEqualToString:@"UIButton"]) {
        self.timeInterval=self.timeInterval>0?self.timeInterval:defaultInterval;
